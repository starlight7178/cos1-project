...
![clone_https_sm](https://drive.google.com/uc?id=1OUEarJOGS9cEjsoigWEHHEt79ZPu6UBI)
...
```
cd ~/Desktop
git clone https://github.com/FullSailGameStudies/cos1-#####.git
```
...
```
/Users/YourUserName/Desktop/cos1-####
```
